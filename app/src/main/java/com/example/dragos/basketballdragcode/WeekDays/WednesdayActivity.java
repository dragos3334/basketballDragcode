...
public class WednesdayActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private Firebase firebase = new Firebase("https://basketball514-6f71d.firebaseio.com/Wednesday_Players");
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot playerSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (chekifIsAlreadyInList(Players, player.getUserId())) {
                        Players.add(player);
                        playerAdapter adapter = new playerAdapter(WednesdayActivity.this, Players);
        ...
        listParticipants = (ListView) findViewById(R.id.listW);
        inButton = (Button) findViewById(R.id.Wbut);
        outButton = (Button) findViewById(R.id.WoutButton);
    ...
    public void onClick(View v) {  if(v == inButton){
        for(Player player: ProfilActivity.Players) {
            if (player.getUserId().equals(userID) && chekifIsAlreadyInList(Players,player.getUserId())){
                ...
                adapter = new playerAdapter(WednesdayActivity.this,Players);
