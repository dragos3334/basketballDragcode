...
public class SaturdayActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private Firebase firebase = new Firebase("https://basketball514-6f71d.firebaseio.com/Saturday_Players");
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot playerSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (chekifIsAlreadyInList(Players, player.getUserId())) {
                        Players.add(player);
                        playerAdapter adapter = new playerAdapter(SaturdayActivity.this, Players);
        ...
        listParticipants = (ListView) findViewById(R.id.listS);
        inButton = (Button) findViewById(R.id.Sbut);
        outButton = (Button) findViewById(R.id.SoutButton);
    ...
    public void onClick(View v) {  if(v == inButton){
        for(Player player: ProfilActivity.Players) {
            if (player.getUserId().equals(userID) && chekifIsAlreadyInList(Players,player.getUserId())){
                ...
                adapter = new playerAdapter(SaturdayActivity.this,Players);
